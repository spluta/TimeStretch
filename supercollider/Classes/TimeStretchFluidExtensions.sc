...
// 	}
//
// 	*stretchResonAndTrans {|inFile, durMult=100, chanArray, startFrame=0, splits = 9, chunkSize = 6553600, filterOrder=129|
...
// 				TimeStretch.mkStretchTemp(fileName++"_"++chan++".scd", fileName++".wav", fileName++"/", durMult, [chan], startFrame, splits[i], chunkSize, filterOrder);
